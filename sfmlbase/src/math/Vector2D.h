...
{
  Vector2D():sf::Vector2f(0.0,0.0){}
  Vector2D(float a, float b):sf::Vector2f(a,b){}
  Vector2D(sf::Vector2u v):sf::Vector2f(v.x,v.y){}
  Vector2D(sf::Vector2i v):sf::Vector2f(v.x,v.y){}
  Vector2D(sf::Vector2f v):sf::Vector2f(v.x,v.y){}

  sf::Vertex ToVertex(sf::Color color = sf::Color::White) {
      return sf::Vertex(sf::Vector2f(x,y),color);
  }
  ...
  inline float    Cross(const Vector2D& v2) const;
...
//------------------------------------------------------------------------
inline float Vector2D::Cross(const Vector2D &v2) const
{
